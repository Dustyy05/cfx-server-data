...
Citizen.CreateThread(function()
	if (GetCurrentResourceName() ~= "Dusty_API") then 
		--StopResource(GetCurrentResourceName());
		print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named Dusty_API for it to work properly with other scripts...");
	end
	--print("[Dusty_API] For support, make sure to join Dusty's official Discord server: discord.gg/dusty");
	--print('^7[^2Dusty-Hosting^7] ^3Use code ^5DustyDev-23 ^3at checkout for ^220% ^3off of selected services.');
end)

tracked = {}

RegisterNetEvent('Dusty_API:PlayerLoaded')
AddEventHandler('Dusty_API:PlayerLoaded', function()
	if (GetCurrentResourceName() ~= "Dusty_API") then 
		TriggerClientEvent('chatMessage', -1, '^1[^5SCRIPT ERROR^1] ^3The script ^1' .. GetCurrentResourceName() .. ' ^3will not work properly... You must '
	.. 'rename the resource to ^1Dusty_API');
	end
	...
	if (tracked[license] == nil) then 
		...
		--'^1[^5Dusty_API^1] ^3The Discord API script was created by Dusty. You may join his Discord at: ^6discord.gg/dusty')
	end
	--TriggerClientEvent('chatMessage', source, 
		--'^7[^2Dusty-Hosting^7] ^3Use code ^5DustyDev-23 ^3at checkout for ^220% ^3off of selected services.');
end)

card = '{"type":"AdaptiveCard","$schema":"http://adaptivecards.io/schemas/adaptive-card.json","version":"1.3","body":[{"type":"Image","url":"' .. Config.Splash.Header_IMG .. '","horizontalAlignment":"Center"},{"type":"Container","items":[{"type":"TextBlock","text":"Dusty_API","wrap":true,"fontType":"Default","size":"ExtraLarge","weight":"Bolder","color":"Light","horizontalAlignment":"Center"},{"type":"TextBlock","text":"' .. Config.Splash.Heading1 .. '","wrap":true,"size":"Large","weight":"Bolder","color":"Light","horizontalAlignment":"Center"},{"type":"TextBlock","text":"' .. Config.Splash.Heading2 .. '","wrap":true,"color":"Light","size":"Medium","horizontalAlignment":"Center"},{"type":"ColumnSet","height":"stretch","minHeight":"100px","bleed":true,"horizontalAlignment":"Center","columns":[{"type":"Column","width":"stretch","items":[{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Discord","url":"' .. Config.Splash.Discord_Link .. '","style":"positive"}],"horizontalAlignment":"Center"}],"height":"stretch"},{"type":"Column","width":"stretch","items":[{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Website","style":"positive","url":"' .. Config.Splash.Website_Link .. '"}],"horizontalAlignment":"Center"}]}]},{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Click to join Dusty\'s Discord","style":"destructive","iconUrl":"https://i.gyazo.com/0904b936e8e30d0104dec44924bd2294.gif","url":"https://discord.com/invite/WjB5VFz"}],"horizontalAlignment":"Center"}],"style":"default","bleed":true,"height":"stretch"},{"type":"Image","url":"https://i.gyazo.com/7e896862b14be754ae8bad90b664a350.png","selectAction":{"type":"Action.OpenUrl","url":"https://zap-hosting.com/badger"},"horizontalAlignment":"Center"}]}'
...
function IsDiscordEmailVerified(user) 
    ...
    if discordId then 
        ...
        if member.code == 200 then
        	...
        	print("[Dusty_API] ERROR: Code 200 was not reached. DETAILS: " .. error_codes_defined[member.code]);
        end
    end
    return isVerified;
end
...
function GetGuildIcon(guild --[[optional]])
  local guildId = GetGuildId(guild)
	...
	if guild.code == 200 then
		...
		print("[Dusty_API] An error occured, please check your config and ensure everything is correct. Error: "..(guild.data or guild.code)) 
	end
	return nil;
end
...
function GetDiscordAvatar(user) 
	...
	if discordId then 
		...
		print("[Dusty_API] ERROR: Discord ID was not found...")
	end
    return imgURL;
end
  ...
  local guildId = GetGuildId(guild)
	...
	if discordId then
        ...
        recent_role_cache[discordId] = recent_role_cache[discordId] or {}
			...
			print("[Dusty_API] ERROR: Code 200 was not reached... Returning false. [Member Data NOT FOUND] DETAILS: " .. error_codes_defined[member.code])
			return false
		end
	else
		print("[Dusty_API] ERROR: Discord was not connected to user's Fivem account...")
		return false
	end
	return false
end
  ...
  local guildId = GetGuildId(guild)
	...
	if discordId then
		...
		if member.code == 200 then
			...
			print("[Dusty_API] ERROR: Code 200 was not reached. Error Code: " .. error_codes_defined[member.code])
			return nil;
		end
	else
		print("[Dusty_API] ERROR: Discord was not connected to user's Fivem account...")
...
Citizen.CreateThread(function()
  ...
  if mguild.code == 200 then
    ...
    print("[Dusty_API] Successful connection to Guild : "..data.name.." ("..data.id..")")
  else
    print("[Dusty_API] An error occured, please check your config and ensure everything is correct. Error: "..(mguild.data and json.decode(mguild.data) or mguild.code)) 
  end
  if (Config.Multiguild) then 
    for _,guildID in pairs(Config.Guilds) do
      ...
      if guild.code == 200 then
        ...
        print("[Dusty_API] An error occured, please check your config and ensure everything is correct. Error: "..(guild.data and json.decode(guild.data) or guild.code)) 
      end
    end
  end
end)
